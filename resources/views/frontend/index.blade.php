...
<link rel="stylesheet" href="{{asset('frontend/template/assets/plugins/jvectormap/jquery-jvectormap-2.0.3.min.css')}}"/>
<link rel="stylesheet" href="{{asset('frontend/template/assets/plugins/morrisjs/morris.min.css')}}" />
<!-- Custom Css -->
<link rel="stylesheet" href="{{asset('frontend/template/assets/css/main.css')}}">
<link rel="stylesheet" href="{{asset('frontend/template/assets/css/color_skins.css')}}">
</head>
<body class="theme-cyan">
<!-- Page Loader -->
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img class="zmdi-hc-spin" src="{{asset('frontend/template/assets/images/logo.svg')}}" width="48" height="48" alt="sQuare"></div>
        <p>Please wait...</p>
    </div>
</div>
    ...
    <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="{{asset('frontend/template/mail-inbox.html')}}">Inbox</a></li>
                                <li><a href="{{asset('frontend/template/chat.html')}}">Chat</a></li>
                                <li><a href="{{asset('frontend/template/events.html')}}">Calendar</a></li>
                                <li><a href="{{asset('frontend/template/file-dashboard.html')}}">File Manager</a></li>
                                <li><a href="{{asset('frontend/template/contact.html')}}">Contact list</a></li>
                            </ul>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <h6>User Interface (UI)</h6>
                            <ul class="list-unstyled">
                                <li><a href="{{('asset/frontend/tamplate/ui_kit.html')}}">UI KIT</a></li>
                                <li><a href="{{('asset/frontend/tamplate/tabs.html')}}">Tabs</a></li>
                                <li><a href="{{('asset/frontend/tamplate/range-sliders.html')}}">Range Sliders</a></li>
                                <li><a href="{{('asset/frontend/tamplate/modals.html')}}">Modals</a></li>
                                <li><a href="{{('asset/frontend/tamplate/alerts.html')}}">Alerts</a></li>
                                <li><a href="{{('asset/frontend/tamplate/dialogs.html')}}">Dialogs</a></li>
                                <li><a href="{{('asset/frontend/tamplate/collapse.html')}}">Collapse</a></li>
                            </ul>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <h6>Sample Pages</h6>
                            <ul class="list-unstyled">
                                <li><a href="{{('asset/frontend/tamplate/image-gallery.html')}}">Image Gallery</a> </li>
                                <li><a href="{{('asset/frontend/tamplate/profile.html')}}">Profile</a></li>
                                <li><a href="{{('asset/frontend/tamplate/timeline.html')}}">Timeline</a></li>
                                <li><a href="{{('asset/frontend/tamplate/pricing.html')}}">Pricing</a></li>
                                <li><a href="{{('asset/frontend/tamplate/invoices.html')}}">Invoices</a></li>
                                <li><a href="{{('asset/frontend/tamplate/search-results.html')}}">Search Results</a></li>
                            </ul>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <h6>About</h6>
                            <ul class="list-unstyled">
                                <li><a href="{{('asset/frontend/tamplate/http://thememakker.com/about/')}}" target="_blank">About</a></li>
                                <li><a href="{{('asset/frontend/tamplate/http://thememakker.com/contact/')}}" target="_blank">Contact Us</a></li>
                                <li><a href="{{('asset/frontend/tamplate/http://thememakker.com/admin-templates/')}}" target="_blank">Admin Templates</a></li>
                                <li><a href="{{('asset/frontend/tamplate/http://thememakker.com/services/')}}" target="_blank">Services</a></li>
                                <li><a href="{{('asset/frontend/tamplate/http://thememakker.com/portfolio/')}}" target="_blank">Portfolio</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12">
                <div class="social">
                    <a class="icon" href="{{('asset/frontend/tamplate/https://www.facebook.com/thememakkerteam" target="_blank')}}"><i class="zmdi zmdi-facebook"></i></a>
                    <a class="icon" href="{{('asset/frontend/tamplate/https://www.behance.net/thememakker" target="_blank')}}"><i class="zmdi zmdi-behance"></i></a>
                    <a class="icon" href="{{('asset/frontend/tamplate/javascript:void(0);"><i class="zmdi zmdi-twitter')}}"></i></a>
                    <a class="icon" href="{{('asset/frontend/tamplate/javascript:void(0);"><i class="zmdi zmdi-linkedin')}}"></i></a>
                    <p>Coded by WrapTheme<br> Designed by <a href="{{('asset/frontend/tamplate/http://thememakker.com/" target="_blank')}}">thememakker.com</a></p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <ul class="menu list-unstyled">
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{asset('frontend/template/assets/images/xs/avatar5.jpg')}}" alt="">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{asset('frontend/template/assets/images/xs/avatar6.jpg')}}" alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{asset('frontend/template/assets/images/xs/avatar3.jpg')}}" alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{asset('frontend/template/assets/images/xs/avatar4.jpg')}}" alt="">
                                    <div class="media-body">
...
<aside id="leftsidebar" class="sidebar">
    <div class="menu">
        <ul class="list">
            <li>
                <div class="user-info">
                    <div class="image"><a href="profile.html"><img src="{{asset('frontend/template/assets/images/profile_av.jpg')}}" alt="User"></a></div>
                    <div class="detail">
                        <h4>Michael</h4>
...
<aside id="rightchat" class="right_chat">
    ...
    <div class="chat_list">
        <ul class="list-unstyled clearfix">
            <li><a href="javascript:void(0);"><img src="{{asset('frontend/template/assets/images/xs/avatar1.jpg')}}" class="rounded-circle" alt=""></a></li>
            <li><a href="javascript:void(0);"><img src="{{asset('frontend/template/assets/images/xs/avatar2.jpg')}}" class="rounded-circle" alt=""></a></li>
            <li class="active"><a href="javascript:void(0);"><img src="{{asset('frontend/template/assets/images/xs/avatar3.jpg')}}" class="rounded-circle" alt=""></a></li>
            <li><a href="javascript:void(0);"><img src="{{asset('frontend/template/assets/images/xs/avatar4.jpg')}}" class="rounded-circle" alt=""></a></li>
            <li><a href="javascript:void(0);"><img src="{{asset('frontend/template/assets/images/xs/avatar5.jpg')}}" class="rounded-circle" alt=""></a></li>
            <li><a href="javascript:void(0);"><img src="{{asset('frontend/template/assets/images/xs/avatar6.jpg')}}" class="rounded-circle" alt=""></a></li>
            <li><a href="javascript:void(0);"><img src="{{asset('frontend/template/assets/images/xs/avatar7.jpg')}}" class="rounded-circle" alt=""></a></li>
            <li><a href="javascript:void(0);"><img src="{{asset('frontend/template/assets/images/xs/avatar8.jpg')}}" class="rounded-circle" alt=""></a></li>
            <li><a href="javascript:void(0);"><img src="{{asset('frontend/template/assets/images/xs/avatar9.jpg')}}" class="rounded-circle" alt=""></a></li>
        </ul>
    </div>
</aside>
<!-- Right Sidebar -->
            ...
            <div class="slim_scroll">
                <div class="card user_activity">
                    ...
                    <div class="streamline b-accent">
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('frontend/template/assets/images/xs/avatar4.jpg')}}" alt="">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('frontend/template/assets/images/xs/avatar5.jpg')}}" alt="">
                            <div class="sl-content">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('frontend/template/assets/images/xs/avatar6.jpg')}}" alt="">
                            <div class="sl-content">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('frontend/template/assets/images/xs/avatar7.jpg')}}" alt="">
                            <div class="sl-content">
...
<!-- Jquery Core Js -->
<script src="{{asset('frontend/template/assets/bundles/libscripts.bundle.js')}}"></script> <!-- Lib Scripts Plugin Js ( jquery.v3.2.1, Bootstrap4 js) -->
<script src="{{asset('frontend/template/assets/bundles/vendorscripts.bundle.js')}}"></script> <!-- slimscroll, waves Scripts Plugin Js -->

<script src="{{asset('frontend/template/assets/bundles/morrisscripts.bundle.js')}}"></script><!-- Morris Plugin Js -->
<script src="{{asset('frontend/template/assets/bundles/jvectormap.bundle.js')}}"></script> <!-- JVectorMap Plugin Js -->
<script src="{{asset('frontend/template/assets/bundles/knob.bundle.js')}}"></script> <!-- Jquery Knob-->

<script src="{{asset('frontend/template/assets/bundles/mainscripts.bundle.js')}}"></script>
<script src="{{asset('frontend/template/assets/js/pages/index.js')}}"></script>
</body>
</html>
