...
<link rel="stylesheet" href="{{asset('backend/template/assets/css/timeline.css')}}">
<link rel="stylesheet" href="{{asset('backend/template/assets/css/color_skins.css')}}"></head>
    ...
    <ul class="nav navbar-nav navbar-left">
        <li>
            <div class="navbar-header">
                ...
                {{-- <span class="navbar-brand" href="index.html"><img src="{{asset('backend/template/assets/images/logo.svg" width="30" alt="sQuare"><span class="m-l-10')}}">sQuare</span></span> --}}
            </div>
        </li>
        <li>
                    ...
                    <ul class="menu list-unstyled">
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{asset('backend/template/assets/images/xs/avatar5.jpg')}}" alt="">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{asset('backend/template/assets/images/xs/avatar6.jpg')}}" alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{asset('backend/template/assets/images/xs/avatar3.jpg')}}" alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{asset('backend/template/assets/images/xs/avatar4.jpg')}}" alt="">
                                    <div class="media-body">
...
<aside id="leftsidebar" class="sidebar">
    <div class="menu">
        <ul class="list">
            <li>
                <div class="user-info">
                    <div class="image')}}"><a href="profile"><img src="{{asset('backend/template/assets/images/user/admin.jpeg')}}" alt="User"></a></div>
                    <div class="detail">
                        <h4>Admin</h4>
        ...
        <ul class="chat-widget m-b-0 clearfix">
            ...
            <li class="left float-left">
                ...
                <div class="chat-info">
                    ...
                    <span class="message">Hello, <br>Admin</span>
                </div>
            </li>
        </ul>
        <div class="enter_msg">
            ...
            <div class="slim_scroll">
                <div class="card user_activity">
                    ...
                    <div class="streamline b-accent">
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('backend/template/assets/images/xs/avatar4.jpg')}}" alt="">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('backend/template/assets/images/xs/avatar5.jpg')}}" alt="">
                            <div class="sl-content">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('backend/template/assets/images/xs/avatar6.jpg')}}" alt="">
                            <div class="sl-content">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('backend/template/assets/images/xs/avatar7.jpg')}}" alt="">
                            <div class="sl-content">
                    ...
                    <div class="body col-white">
                        <div class="row">
                            <div class="col-lg-3 col-md-4 col-12">
                                <div class="profile-image float-md-right"> <img src="{{asset('backend/template/assets/images/user/admin.jpeg')}}" alt=""> </div>
                            </div>
                            <div class="col-lg-9 col-md-8 col-12">
                                <h4 class="m-t-0 m-b-0"><strong>Admin</strong></h4>
...
<!-- Jquery Core Js -->
<script src="{{asset('backend/template/assets/bundles/libscripts.bundle.js')}}"></script> <!-- Lib Scripts Plugin Js -->
<script src="{{asset('backend/template/assets/bundles/vendorscripts.bundle.js')}}"></script> <!-- Lib Scripts Plugin Js -->

<script src="{{asset('backend/template/assets/bundles/knob.bundle.js')}}"></script> <!-- Jquery Knob Plugin Js -->

<script src="{{asset('backend/template/assets/bundles/mainscripts.bundle.js')}}"></script><!-- Custom Js -->
<script src="{{asset('backend/template/assets/js/pages/charts/jquery-knob.js')}}"></script>
</body>
</html>
